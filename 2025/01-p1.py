...
for line in lines:
    ...
    print(f"Rotation: {letter}; Number: {number}")

    print(f"Old position: {dial_np.state}")

    dial_np.rotate(letter, number)

    print(f"New position: {dial_np.state}")
